...
export const ActionsColumnFormatter = (
  ...
  row,
  rowIndex,
  { openEditUrlPage, openDeleteUrlDialog }
) => (
  <>

    <> </>

    <OverlayTrigger overlay={<Tooltip id="url-edit-tooltip">Edit</Tooltip>}>
      <a
        className="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"
        onClick={() => openEditUrlPage(row.id)}
      >
    ...
    >
      <a
        ...
        onClick={() => openDeleteUrlDialog(row.id)}
      >
