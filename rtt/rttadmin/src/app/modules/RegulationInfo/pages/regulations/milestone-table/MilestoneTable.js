...
import * as uiHelpers from "../../regulations/RegulationUIHelpers";
...
export function MilestoneTable({ regulationId }) {
  const dispatch = useDispatch();

  const { relatedMilestones } = useSelector((state) => ({ relatedMilestones: state.regulation?.relatedMilestones }), []);
