...
export function SourceFilter({ listLoading }) {
  // Source UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(sourceUIProps.queryParams, values);
    if (!isEqual(newQueryParams, sourceUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      sourceUIProps.setQueryParams(newQueryParams);
    }
  };
