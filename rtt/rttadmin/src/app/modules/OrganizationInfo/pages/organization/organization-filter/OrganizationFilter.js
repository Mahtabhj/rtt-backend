...
export function OrganizationFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(organizationUIProps.queryParams, values);
    if (!isEqual(newQueryParams, organizationUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      organizationUIProps.setQueryParams(newQueryParams);
    }
  };
