...
const fakeData = [
  ...
  },
  {
    ...
    iconImage: toAbsoluteUrl("/static/files/doc.svg"),
  },
  {
    type: 1,
    text: "TechNav Documentation",
    description: "by Mary Brown",
    iconImage: toAbsoluteUrl("/static/files/pdf.svg"),
  },
  {
    type: 1,
    text: "All Framework Docs",
    description: "by Grog John",
    iconImage: toAbsoluteUrl("/static/files/zip.svg"),
  },
  {
    type: 1,
    text: "AirPlus Requirements",
    description: "by Tim Hardy",
    iconImage: toAbsoluteUrl("/static/files/xml.svg"),
  },
  {
    text: "Customers",
    type: 0,
  },
  {
    ...
    iconImage: toAbsoluteUrl("/static/users/300_11.jpg"),
  },
  {
    type: 1,
    text: "Milena Gibson",
    description: "UI Designer",
    iconImage: toAbsoluteUrl("/static/users/300_16.jpg"),
  },
  {
    type: 1,
    text: "Stefan JohnStefan",
    description: "Marketing Manager",
    iconImage: toAbsoluteUrl("/static/users/300_22.jpg"),
  },
  {
    type: 1,
    text: "Anna Strong",
    description: "Software Developer",
    iconImage: toAbsoluteUrl("/static/users/300_5.jpg"),
  },
  {
    type: 0,
    text: "Files",
        ...
        <div className="topbar-item">
          ...
          >
            <span className="svg-icon svg-icon-xl svg-icon-primary">
              <SVG src={toAbsoluteUrl("/static/svg/icons/General/Search.svg")} />
            </span>
          </div>
        </div>
      )}
          ...
          <Dropdown.Toggle as={DropdownTopbarItemToggler}>
            ...
            >
              <div className="btn btn-icon btn-clean btn-lg btn-dropdown mr-1">
                <span className="svg-icon svg-icon-xl svg-icon-primary">
                  <SVG
                    src={toAbsoluteUrl("/static/svg/icons/General/Search.svg")}
                  />
                </span>
              </div>
            </OverlayTrigger>
                  ...
                  <div className={`input-group-prepend`}>
                    <span className="input-group-text">
                      <span className="svg-icon svg-icon-lg">
                        <SVG
                          src={toAbsoluteUrl(
                            "/static/svg/icons/General/Search.svg"
                          )}
                        />
                      </span>
                    </span>
