...
export function UserNotificationsDropdown() {
  ...
  const bgImage = toAbsoluteUrl(process.env.REACT_APP_STATIC_PATH + "/misc/bg-1.jpg");
        ...
        <div className="topbar-item">
          ...
          >
            <span className="svg-icon svg-icon-xl svg-icon-primary">
              <SVG src={toAbsoluteUrl(process.env.REACT_APP_STATIC_PATH + "/svg/icons/Code/Compiling.svg")} />
            </span>
          ...
          >
            ...
            >
              ...
              >
                <span className="svg-icon svg-icon-xl svg-icon-primary">
                  <SVG
                    src={toAbsoluteUrl(process.env.REACT_APP_STATIC_PATH + "/svg/icons/Code/Compiling.svg")}
                  />
                </span>
                <span className="pulse-ring"></span>
                        ...
                        <div className="d-flex align-items-center mb-6">
                          <div className="symbol symbol-40 symbol-light-primary mr-5">
                            <span className="symbol-label">
                              <SVG
                                src={toAbsoluteUrl(
                                  process.env.REACT_APP_STATIC_PATH + "/svg/icons/Home/Library.svg"
                                )}
                        ...
                        <div className="d-flex align-items-center mb-6">
                          <div className="symbol symbol-40 symbol-light-warning mr-5">
                            <span className="symbol-label">
                              <SVG
                                src={toAbsoluteUrl(
                                  process.env.REACT_APP_STATIC_PATH + "/svg/icons/Communication/Write.svg"
                                )}
                        ...
                        <div className="d-flex align-items-center mb-6">
                          <div className="symbol symbol-40 symbol-light-success mr-5">
                            <span className="symbol-label">
                              <SVG
                                src={toAbsoluteUrl(
                                  process.env.REACT_APP_STATIC_PATH + "/svg/icons/Communication/Group-chat.svg"
                                )}
                        ...
                        <div className="d-flex align-items-center mb-6">
                          <div className="symbol symbol-40 symbol-light-danger mr-5">
                            <span className="symbol-label">
                              <SVG
                                src={toAbsoluteUrl(
                                  process.env.REACT_APP_STATIC_PATH + "/static/svg/icons/General/Attachment2.svg"
                                )}
                        ...
                        <div className="d-flex align-items-center mb-2">
                          <div className="symbol symbol-40 symbol-light-info mr-5">
                            <span className="symbol-label">
                              <SVG
                                src={toAbsoluteUrl(
                                  "/static/svg/icons/General/Attachment2.svg"
                                )}
                        ...
                        <div className="d-flex align-items-center mb-2">
                          <div className="symbol symbol-40 symbol-light-info mr-5">
                            <span className="symbol-label">
                              <SVG
                                src={toAbsoluteUrl(
                                  "/static/svg/icons/Design/Bucket.svg"
                                )}
                                className="svg-icon-lg svg-icon-info"
                              ></SVG>
                            </span>
