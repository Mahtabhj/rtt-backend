...
export function QuickActionsDropdown() {
  const bgImage = toAbsoluteUrl("/static/misc/bg-2.jpg");
          ...
          <div className="topbar-item">
            ...
            >
              <span className="svg-icon svg-icon-xl svg-icon-primary">
                <SVG
                  src={toAbsoluteUrl("/static/svg/icons/Media/Equalizer.svg")}
                />
              </span>
            </div>
          </div>
                ...
                <div className="col-6">
                  ...
                  >
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/static/svg/icons/Shopping/Euro.svg"
                        )}
                      ></SVG>
                    </span>
                ...
                <div className="col-6">
                  ...
                  >
                    ...
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/static/svg/icons/Communication/Mail-attachment.svg"
                        )}
                      ></SVG>
                    </span>
                    <span className="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">
                ...
                <div className="col-6">
                  ...
                  >
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/static/svg/icons/Shopping/Box2.svg"
                        )}
                      ></SVG>
                    </span>
                    <span className="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">
                ...
                <div className="col-6">
                  ...
                  >
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG
                        src={toAbsoluteUrl(
                          "/static/svg/icons/Communication/Group.svg"
                        )}
                      ></SVG>
                    </span>
                    <span className="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">
