...
export function MyCartDropdown() {
  const bgImage = toAbsoluteUrl("/static/misc/bg-1.jpg");
  return (
        ...
        >
          <div className="btn btn-icon btn-clean btn-lg mr-1">
            <span className="svg-icon svg-icon-xl svg-icon-primary">
              <SVG src={toAbsoluteUrl("/static/svg/icons/Shopping/Cart3.svg")} />
            </span>
          </div>
        </OverlayTrigger>
      </Dropdown.Toggle>
          ...
          >
            <div className="d-flex align-items-center justify-content-between p-8">
              ...
              <a href="#" className="symbol symbol-70 flex-shrink-0">
                <img
                  src={toAbsoluteUrl("/static/stock-600x400/img-1.jpg")}
                  alt=""
                />
              </a>
            </div>
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              ...
              <a href="#" className="symbol symbol-70 flex-shrink-0">
                <img
                  src={toAbsoluteUrl("/static/stock-600x400/img-2.jpg")}
                  alt=""
                />
              </a>
            </div>
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              ...
              <a href="#" className="symbol symbol-70 flex-shrink-0">
                <img
                  src={toAbsoluteUrl("/static/stock-600x400/img-3.jpg")}
                  alt=""
                />
              </a>
            </div>
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              ...
              <a href="#" className="symbol symbol-70 flex-shrink-0">
                <img
                  src={toAbsoluteUrl("/static/stock-600x400/img-4.jpg")}
                  alt=""
                />
              </a>
            </div>
