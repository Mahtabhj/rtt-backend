          ...
          <>
            ...
            {layoutProps.light && (<>
              <div className="d-flex align-items-center p-8 rounded-top">
                ...
                <div className="symbol symbol-md bg-light-primary mr-3 flex-shrink-0">
                  <img src={toAbsoluteUrl(process.env.REACT_APP_STATIC_PATH + "/users/300_21.jpg")} alt=""/>
                </div>
            ...
            {!layoutProps.light && (
                <div
                    ...
                    style={{
                      backgroundImage: `url(${toAbsoluteUrl(process.env.REACT_APP_STATIC_PATH + "/misc/bg-1.jpg")})`
                    }}
                >
