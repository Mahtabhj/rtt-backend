              ...
              >
                <div className="mb-15">
                  ...
                  <div className="d-flex align-items-center flex-wrap mb-5">
                    ...
                    <span className="symbol-label">
                      <img
                          src={toAbsoluteUrl("/static/svg/misc/006-plurk.svg")}
                          alt=""
                  ...
                  <div className="d-flex align-items-center flex-wrap mb-5">
                    ...
                    <span className="symbol-label">
                      <img
                          src={toAbsoluteUrl("/static/svg/misc/015-telegram.svg")}
                          alt=""
                          className="h-50 align-self-center"
                      />
                    </span>
                  ...
                  <div className="d-flex align-items-center flex-wrap mb-5">
                    ...
                    <span className="symbol-label">
                      <img
                          src={toAbsoluteUrl("/static/svg/misc/003-puzzle.svg")}
                          alt=""
                          className="h-50 align-self-center"
                      />
                    </span>
                  ...
                  <div className="d-flex align-items-center flex-wrap mb-5">
                    ...
                    <span className="symbol-label">
                      <img
                          src={toAbsoluteUrl("/static/svg/misc/005-bebo.svg")}
                          alt=""
                          className="h-50 align-self-center"
                      />
                    </span>
                  ...
                  <div className="d-flex align-items-center flex-wrap">
                    ...
                    <span className="symbol-label">
                      <img
                          src={toAbsoluteUrl(
                              "/static/svg/misc/014-kickstarter.svg"
                          )}
                          alt=""
                          className="h-50 align-self-center"
                      />
                ...
                <div className="mb-5">
                  ...
                  <span className="svg-icon svg-icon-warning mr-5">
                    <SVG
                        src={toAbsoluteUrl("/static//svg/icons/Home/Library.svg")}
                  ...
                  <span className="svg-icon svg-icon-success mr-5">
                    <SVG
                        src={toAbsoluteUrl(
                            "/static/svg/icons/Communication/Write.svg"
                        )}
                        className="svg-icon svg-icon-lg"
                    ></SVG>
                  </span>
                  ...
                  <span className="svg-icon svg-icon-danger mr-5">
                    <SVG
                        src={toAbsoluteUrl(
                            "/static/svg/icons/Communication/Group-chat.svg"
                        )}
                        className="svg-icon svg-icon-lg"
                    ></SVG>
                  </span>
